...
def main():
    ...
    possible_arm_combinations_all_targets, tms, tms_up, tms_down = remove_arm_combinations_max_delta_tm(possible_arm_combinations_all_targets,
                                                                                                        tms, tms_up, tms_down, max_delta_tm_probe)
...
def remove_arm_combinations_max_delta_tm(possible_arm_combinations_all_targets, tms, tms_up, tms_down, max_delta_tm_probe):
    boolean_array = []
    new_tms = []
    new_tms_down = []
    new_tms_up = []
    ...
    for i, row in enumerate(tms):
        boolean_row = np.array(row < max_delta_tm_probe, dtype=bool)  # Create a boolean array with all values that are lower than the delta Tm threshold.
